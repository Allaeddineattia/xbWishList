...
use crate::game::repo::purchase_option_repo::PurchaseAvailabilityRepo;
...
impl GameRepo{
    pub async fn new(data_base : & Database) -> GameRepo{
        let purchase_availability_repo= PurchaseAvailabilityRepo::new();
...
impl Repo<GameModel> for GameRepo{
