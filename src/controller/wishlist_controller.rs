...
impl WishlistController{
    ...
    pub async fn get_game_list_from_dto(&self, dto_games: Vec<dto::input::WishlistElement>, wishlist_pref: &crate::core::wishlist::WishlistPreferences) -> Result<HashMap<String, WishlistElement>, String>
    {
